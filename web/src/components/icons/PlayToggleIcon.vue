<template>
	...
	>
		...
		<path
			...
			d="M509 212C624 282 742 353 858 423C875 434 888 451 895 469C903 488 905 501 905 512C905 523 903 536 895 555C888 573 875 590 858 601C742 671 624 742 509 812C509 812 509 512 509 512C509 512 509 212 509 212Z"
		/>
	</svg>
</template>
...
.play-toggle-icon {
	...
	&__shape {
		...
		&--right {
				d: path(
					'M 509 212 C 624 282 742 353 858 423 C 875 434 888 451 895 469 C 903 488 905 501 905 512 C 905 523 903 536 895 555 C 888 573 875 590 858 601 C 742 671 624 742 509 812 C 509 812 509 512 509 512 C 509 512 509 212 509 212 Z'
				);
		}
	}
